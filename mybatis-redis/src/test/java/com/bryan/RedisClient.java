...
public class RedisClient {
    ...
    private void KeyOperate() {
        ...
        System.out.println("清空库中所有数据："+jedis.flushDB());
        // 判断key否存在
        System.out.println("判断key9键是否存在："+jedis.exists("key9"));
        System.out.println("新增key1,value1键值对："+jedis.set("key1", "value1"));
        System.out.println("判断key1是否存在："+jedis.exists("key1"));
        // 输出系统中所有的key
        System.out.println("新增key2,value2键值对："+jedis.set("key2", "value2"));
        ...
        System.out.println("系统中删除key2: "+jedis.del("key2"));
        System.out.println("判断key2是否存在："+jedis.exists("key2"));
        // 设置 key1的过期时间
        System.out.println("设置 key1的过期时间为5秒:"+jedis.expire("key1", 5));
        try{
            Thread.sleep(2000);
        }
        ...
        System.out.println("查看key1的剩余生存时间："+jedis.ttl("key1"));
        // 移除某个key的生存时间
        System.out.println("移除key1的生存时间："+jedis.persist("key1"));
        System.out.println("查看key1的剩余生存时间："+jedis.ttl("key1"));
        // 查看key所储存的值的类型
        System.out.println("查看key所储存的值的类型："+jedis.type("key1"));
        /*
    ...
    private void StringOperate() {
        ...
        System.out.println("删除key3键值对："+jedis.del("key3"));
        System.out.println("获取key3键对应的值："+jedis.get("key3"));

        System.out.println("=============改=============");
        //1、直接覆盖原来的数据
        System.out.println("直接覆盖key1原来的数据："+jedis.set("key1","value1-update"));
        System.out.println("获取key1对应的新值："+jedis.get("key1"));
        //2、直接覆盖原来的数据
        System.out.println("在key2原来值后面追加："+jedis.append("key2","+appendString"));
        System.out.println("获取key2对应的新值"+jedis.get("key2"));
